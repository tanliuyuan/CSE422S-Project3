...
To compile all the .cpp source code and produce the executables all at once, run the makefile by calling “make” under the source file folder. This call will automatically generate all three executables.

To compile and generate each executable individually, run “make [name_of_executable]”. For example: make vmsim. 

To delete all files generated by the makefile, run “make clean” under the source file folder.
